...
int main(int argc, char *argv[])
{
	...
	long a = ctos(cs, height, width, 1, 1);
	long b = ctos(cs, height, width, 3, 1);
	long c = ctos(cs, height, width, 5, 1);
	long d = ctos(cs, height, width, 7, 1);
	long e = ctos(cs, height, width, 1, 2);
